...
const App = () => {
  ...
  const keyMetrics = [
    ...
    { title: 'Avg. Order Value', value: '$101.50', trend: '+3% vs last month', icon: '💲' },
    { title: 'Customer Churn', value: '1.2%', trend: '-0.1% vs last month', icon: '📉' },
    { title: 'Website Traffic', value: '56,789', trend: '+15% vs last month', icon: '🌐' },
    { title: 'Support Tickets', value: '45', trend: '-10% vs last month', icon: '💬' },
  ];
  ...
  const recentTransactions = [
    ...
    { id: 'T006', item: 'Product F', amount: '$75.00', status: 'Completed', date: '2023-10-23' },
    { id: 'T007', item: 'Service G', amount: '$30.00', status: 'Pending', date: '2023-10-22' },
  ];
